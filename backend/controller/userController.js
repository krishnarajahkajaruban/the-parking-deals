...
const carParkingBookingDetail = async (req, res) => {
    try {
        ...
        if (accessToken && !adminBooking) {
          ...
          const result = await register(email, title, firstName, lastName, null, null, mobileNumber, "Offline-User", null, null, null, null, null, null, null, null, null, null, user.id, null);
          ...
          user = result.user;
            ...
            const result = await register(email, title, firstName, lastName, null, password, mobileNumber, "User", null, null, null, null, null, null, null, null, null, null, null, null, null);
