...
const Vendors = () => {
    ...
    const handleChange = async(e) => {
        ...
        setVendorData({...vendorData, [name]: files? files?.[0] : value, ...(name === 'quote' && { finalQuote: value})});
        if (name === "email") {
            setShowError(false);
            setEmailExist(false);
            try {
    ...
    const createVendor = async (vendorFormData) => {
        ...
        try {
          ...
          const response = await api.post("/api/admin/create-vendor", vendorFormData, {
            headers: { 
    ...
    const updateVendor = async (vendorFormData) => {
        setLoading(true);
        try {
          const response = await api.put(`/api/admin/update-vendor-info/${selectedVendorId}`, vendorFormData, {
            headers: { 
                Authorization: `Bearer ${token}`,
                'Content-Type': 'multipart/form-data'
            }
                ...
                <Button
                    ...
                    onClick={() => {
                        setVendorData({
                            ...
                            facilities:rowData?.facilities?.length >0 ? rowData?.facilities : [''], 
                ...
                <div className="page_content">
                    {vendorsData?.length > 0 ? (
                        <div className="dash-table-area">
                            ...
                            >
                                <Column header="Name" field="companyName" style={{ width: "20%" }} ></Column>

                                <Column header="Type" field="serviceType" style={{ width: "20%" }} ></Column>
                                ...
                                <Column header="Quote" field="finalQuote" style={{ width: "10%" }}></Column>
                ...
                <div className="modal-body p-2">
                    <div className="data-view-area">
                        <div className="row">
                            ...
                            <div className="col-12 col-sm-6">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    <label htmlFor="verify_email" className="custom-form-label form-required">
                                        Email
                                    </label>
                                    <InputText
                                        id="email"
                            ...
                            <div className="col-12 col-sm-6">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    ...
                                    <small className='text-danger form-error-msg'>{(!(/^\d{9,}$/.test(vendorData.mobileNumber)) && vendorData.mobileNumber) ? "Enter valid phone number" : ""}</small>
                                </div>
                            </div>
                            ...
                            {dataState === 'Add' && (
                                ...
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    ...
                                    <small className='text-danger form-error-msg'>{(vendorData.password.length < 8 && vendorData.password) ? "Password must be atleast 8 characters long" : ""}</small>
                                </div>
                                    </div>
                                    ...
                                    <div className="col-12 col-sm-6">
                                        <div className="custom-form-group mb-3 mb-sm-4">
                                            ...
                                            <small className='text-danger text-capitalized form-error-message'>{(vendorData.password !== vendorData.confirmPassword && vendorData.confirmPassword) ? "Password & Confirm Password must be equal" : ""}</small>
                                        </div>
                                    </div>
                                </> )
                            }
                            ...
                            <div className="col-12 col-sm-6">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    <label htmlFor="discountQuote" className="custom-form-label form-required">
                                        Discount Quote
                                    </label>
                                    <InputNumber
                                        id="discountQuote"
                            ...
                            <div className="col-12 col-sm-6">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    ...
                                    <Dropdown id="type" name="serviceType" value={{type: vendorData.serviceType}} onChange={(e)=>setVendorData({...vendorData, serviceType:e.value?.type})} options={serviceTypes} optionLabel="type"
                            ...
                            <div className="col-12">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    ...
                                    <Editor
                                        ...
                                        onTextChange={(e)=>setVendorData({...vendorData, overView:e.htmlValue})}
                                        style={{ height: '300px' }}
                                    />
                            ...
                            <div className="col-12">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    ...
                                    <Editor
                                        ...
                                        onTextChange={(e)=>setVendorData({...vendorData, dropOffProcedure:e.htmlValue})}
                                        style={{ height: '300px' }} />
                            ...
                            <div className="col-12">
                                <div className="custom-form-group mb-3 mb-sm-4">
                                    ...
                                    <Editor
                                        ...
                                        onTextChange={(e)=>setVendorData({...vendorData, pickUpProcedure:e.htmlValue})}
                                        style={{ height: '300px' }} />
